        ...
        LazyColumn(
            ...
            item {
                CardGroup(
                    ...
                    item(
                        onClick = {
                            updateDisplaySetting(displaySetting.copy(showUpdates = !displaySetting.showUpdates))
                        },
                        ...
                        trailingContent = {
                            Switch(
                                ...
                                onCheckedChange = { updateDisplaySetting(displaySetting.copy(showUpdates = it)) },
                            )
                        },
                    )
                    item(
