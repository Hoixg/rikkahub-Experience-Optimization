...
object PermissionHelper {
    ...
    fun hasAccessibilityService(@Suppress("UNUSED_PARAMETER") ctx: Context): Boolean = false

    fun accessibilitySettingsIntent(): Intent =
        Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS)
            .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)

    fun hasNotificationListener(@Suppress("UNUSED_PARAMETER") ctx: Context): Boolean = false
